...
export const products:Product[] = [
    ...
    sizes:[{size:'s',amount:2,available:2},{size:'m',amount:2,available:2}]},
    {id:3,name:'Camiseta 3',description:'Camiseta estampada en tecnica',amount:10,available:10,created:'2023-04-10',offer:10,type:'t-shirts',price:25000,imagepath:IMAGEPATH+'/shirts/tshirt_3.jpg',rating:'3',
    sizes:[{size:'s',amount:2,available:2},{size:'m',amount:2,available:2}]},
    ...
    sizes:[{size:'s',amount:2,available:2},{size:'m',amount:2,available:2}]},
    {id:8,name:'Mug 2',description:'Mug estampada en tecnica',amount:10,available:10,created:'2023-04-11',type:'Mugs',offer:null,price:25000,imagepath:IMAGEPATH+'/mugs/mug_2.jpg',rating:'3',
    sizes:[{size:'s',amount:2,available:2},{size:'m',amount:2,available:2}]},
